...
![imagen11](./images/a3_acceso_remoto_con_ssh/10.png)

![imagen12](./images/a3_acceso_remoto_con_ssh/11.png)

Comprobamos haciendo ping a ambos equipos.

![imagen13](./images/a3_acceso_remoto_con_ssh/12.png)
...
![imagen15](./images/a3_acceso_remoto_con_ssh/13.png)

Nos descargamos la versión para Windows.

![imagen16](./images/a3_acceso_remoto_con_ssh/14.png)

Empezamos a instalar PuTTY siguiendo las siguientes imagenes.

![imagen17](./images/a3_acceso_remoto_con_ssh/15.png)

![imagen18](./images/a3_acceso_remoto_con_ssh/16.png)

![imagen19](./images/a3_acceso_remoto_con_ssh/17.png)

![imagen20](./images/a3_acceso_remoto_con_ssh/18.png)
...
![imagen21](./images/a3_acceso_remoto_con_ssh/19.png)

![imagen22](./images/a3_acceso_remoto_con_ssh/20.png)

Añadimos en C:\Windows\System32\drivers\etc\hosts los equipos ssh-server20 y ssh-client20a.

![imagen23](./images/a3_acceso_remoto_con_ssh/21.png)

Comprobamos haciendo ping a ambos equipos.

![imagen24](./images/a3_acceso_remoto_con_ssh/22.png)
...
![imagen25](./images/a3_acceso_remoto_con_ssh/23.png)

Ahora utilizamos el comando zypper install openssh y nos instalara el paquete OpenSSH.

![imagen26](./images/a3_acceso_remoto_con_ssh/24.png)
...
![imagen30](./images/a3_acceso_remoto_con_ssh/28.png)
...
![imagen31](./images/a3_acceso_remoto_con_ssh/29.png)

![imagen32](./images/a3_acceso_remoto_con_ssh/30.png)
...
![imagen35](./images/a3_acceso_remoto_con_ssh/31.png)

![imagen36](./images/a3_acceso_remoto_con_ssh/32.png)

Si nos volvemos a conectar tendremos.

![imagen37](./images/a3_acceso_remoto_con_ssh/33.png)

![imagen37](./images/a3_acceso_remoto_con_ssh/34.png)

Comprobamos el contenido del fichero $HOME/.ssh/known_hosts en el equipo ssh-client1.

![imagen38](./images/a3_acceso_remoto_con_ssh/35.png)
...
![imagen39](./images/a3_acceso_remoto_con_ssh/36.png)
...
![imagen41](./images/a3_acceso_remoto_con_ssh/37.png)
...
![imagen42](./images/a3_acceso_remoto_con_ssh/38.png)
...
![imagen45](./images/a3_acceso_remoto_con_ssh/41.png)
...
![imagen46](./images/a3_acceso_remoto_con_ssh/42.png)

Además, creamos el fichero /home/hernandez1/.alias con el siguiente contenido.

![imagen47](./images/a3_acceso_remoto_con_ssh/43.png)
...
![imagen48](./images/a3_acceso_remoto_con_ssh/44.png)

Comprobamos el funcionamiento de la conexión SSH desde cada cliente.

![imagen49](./images/a3_acceso_remoto_con_ssh/45.png)

![imagen50](./images/a3_acceso_remoto_con_ssh/46.png)
...
![imagen51](./images/a3_acceso_remoto_con_ssh/47.png)

![imagen52](./images/a3_acceso_remoto_con_ssh/48.png)
...
![imagen53](./images/a3_acceso_remoto_con_ssh/49.png)

Comprobar que ahora al acceder remotamente vía SSH
Desde ssh-clientXXa, NO se pide password.
Desde ssh-clientXXb, SI se pide el password.

![imagen54](./images/a3_acceso_remoto_con_ssh/50.png)

![imagen55](./images/a3_acceso_remoto_con_ssh/51.png)

![imagen56](./images/a3_acceso_remoto_con_ssh/52.png)
...
![imagen57](./images/a3_acceso_remoto_con_ssh/53.png)

![imagen58](./images/a3_acceso_remoto_con_ssh/54.png)

![imagen59](./images/a3_acceso_remoto_con_ssh/55.png)
...
![imagen60](./images/a3_acceso_remoto_con_ssh/56.png)

![imagen61](./images/a3_acceso_remoto_con_ssh/57.png)

Vamos al cliente20a.

Comprobamos que no está instalada APP1: zypper se APP1.

![imagen62](./images/a3_acceso_remoto_con_ssh/58.png)
...
![imagen63](./images/a3_acceso_remoto_con_ssh/59.png)
...
![imagen64](./images/a3_acceso_remoto_con_ssh/60.png)
...
![imagen65](./images/a3_acceso_remoto_con_ssh/61.png)

![imagen66](./images/a3_acceso_remoto_con_ssh/62.png)

Comprobamos el funcionamiento de APP2 en ssh-server.

![imagen67](./images/a3_acceso_remoto_con_ssh/63.png)

Comprobamos funcionamiento de APP2, accediendo desde ssh-client1.

![imagen68](./images/a3_acceso_remoto_con_ssh/64.png)

![imagen69](./images/a3_acceso_remoto_con_ssh/65.png)
