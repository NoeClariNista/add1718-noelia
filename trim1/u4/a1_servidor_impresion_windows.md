...
Tenemos que ir a Administrar y vamso a Agregar roles y características.
...
En PDFCreator, configuramos en perfiles -> Guardar -> Automático. Ahí configuramos carpeta destino.

![imagen20](./images/a1_servidor_impresion_windows/20.png) <- FALTA
...
![imagen47](./images/a1_servidor_impresion_windows/47.png)
